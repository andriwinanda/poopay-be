...
async function create(req, res) {
  try {
    const { userId, productId, providerId, quantity, price, shipment, total, status } = req.body
    const order = new OrderModel({ userId, productId, providerId, quantity, price, shipment, total, status })
...
async function update(req, res) {
  const { userId, productId, providerId, quantity, price, shipment, total, status } = req.body
  let order = new OrderModel({ userId, productId, providerId, quantity, price, shipment, total, status }, { _id: false })
  const { id } = req.params
  try {
